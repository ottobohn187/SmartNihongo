...
<head id="html-head">
	...
	<link rel="stylesheet" href="<?php echo $config->urls->templates; ?>styles/main.css?v=20260520-pages1">
	<script defer src="<?php echo $config->urls->templates; ?>scripts/main.js?v=20260520-pages1"></script>
</head>
			...
			<div class="mx-auto max-w-7xl px-4">
				<div class="flex items-center justify-between gap-4 py-4">
					...
					<nav class="hidden items-center gap-2 text-sm font-semibold md:flex" aria-label="Main navigation">
						...
						<a href="<?php echo $config->urls->root; ?>flashcards/" class="rounded-2xl px-4 py-3 no-underline transition hover:bg-white/10 hover:text-white<?php echo $active === 'flashcards' ? ' bg-white/10 text-white shadow-inner' : ' text-slate-200'; ?>">Flashcards</a>
						<a href="<?php echo $config->urls->root; ?>restaurant-talk/" class="rounded-2xl px-4 py-3 no-underline transition hover:bg-white/10 hover:text-white<?php echo $active === 'restaurant-talk' ? ' bg-white/10 text-white shadow-inner' : ' text-slate-200'; ?>">Restaurant Talk</a>
				...
				<nav id="sn-mobile-menu" class="hidden pb-4 md:hidden" aria-label="Mobile navigation">
					<div class="grid gap-2 rounded-2xl border border-white/10 bg-[#0b1220] p-3 text-sm font-semibold shadow-[0_18px_40px_rgba(0,0,0,0.35)]">
						...
						<a href="<?php echo $config->urls->root; ?>flashcards/" class="rounded-xl px-3 py-2 text-slate-200 no-underline hover:bg-white/10 hover:text-white">Flashcards</a>
						<a href="<?php echo $config->urls->root; ?>restaurant-talk/" class="rounded-xl px-3 py-2 text-slate-200 no-underline hover:bg-white/10 hover:text-white">Restaurant Talk</a>
